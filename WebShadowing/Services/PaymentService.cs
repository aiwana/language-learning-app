...
// Chức năng: adapter/handler thanh toán, xác minh chữ ký/MAC và webhook idempotent.
// Phụ trách chính: Minh. Trạng thái production chưa hoàn thiện; không log secret/signature.
