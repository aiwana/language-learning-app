...
// Chức năng: buộc user đã đăng nhập hoàn tất onboarding trước khi vào trang/API học tập.
// Phụ trách chính: Minh. MVC redirect về Authen; API trả 403 thay vì HTML.
